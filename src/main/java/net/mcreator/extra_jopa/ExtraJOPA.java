 ...
 *
 *    Keep the ElementsExtraJOPA object in this class and all calls to this object
...
@Mod(modid = ExtraJOPA.MODID, version = ExtraJOPA.VERSION)
public class ExtraJOPA {
	...
	public ElementsExtraJOPA elements = new ElementsExtraJOPA();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsExtraJOPA.GuiHandler());
